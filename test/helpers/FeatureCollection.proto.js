...
$root.esriPBuffer = (function () {
  ...
  esriPBuffer.FeatureCollectionPBuffer = (function () {
    ...
    FeatureCollectionPBuffer.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            message.queryResult = $root.esriPBuffer.FeatureCollectionPBuffer.QueryResult.decode(
              reader,
              reader.uint32(),
            );
            break;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    FeatureCollectionPBuffer.decodeDelimited = function decodeDelimited(reader) {
    ...
    FeatureCollectionPBuffer.SpatialReference = (function () {
      ...
      SpatialReference.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.esriPBuffer.FeatureCollectionPBuffer.SpatialReference();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    FeatureCollectionPBuffer.GeometryField = (function () {
      ...
      GeometryField.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.esriPBuffer.FeatureCollectionPBuffer.GeometryField();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
              message.field = $root.esriPBuffer.FeatureCollectionPBuffer.Field.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      Geometry.decode = function decode(reader, length) {
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 2: {
              if (!(message.lengths && message.lengths.length)) message.lengths = [];
              if ((tag & 7) === 2) {
            ...
            case 3: {
              if (!(message.coords && message.coords.length)) message.coords = [];
              if ((tag & 7) === 2) {
                var end2 = reader.uint32() + reader.pos;
    ...
    FeatureCollectionPBuffer.esriShapeBuffer = (function () {
      ...
      esriShapeBuffer.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.esriPBuffer.FeatureCollectionPBuffer.esriShapeBuffer();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      Feature.encode = function encode(message, writer) {
        ...
        if (message.shapeBuffer != null && Object.hasOwnProperty.call(message, 'shapeBuffer'))
          $root.esriPBuffer.FeatureCollectionPBuffer.esriShapeBuffer
            .encode(message.shapeBuffer, writer.uint32(/* id 3, wireType 2 =*/ 26).fork())
            .ldelim();
          ...
          switch (tag >>> 3) {
            case 1: {
              ...
              message.attributes.push(
                $root.esriPBuffer.FeatureCollectionPBuffer.Value.decode(reader, reader.uint32()),
              );
              break;
            }
            case 2: {
              message.geometry = $root.esriPBuffer.FeatureCollectionPBuffer.Geometry.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 4: {
              message.centroid = $root.esriPBuffer.FeatureCollectionPBuffer.Geometry.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 5: {
              ...
              message.aggregateGeometries.push(
                $root.esriPBuffer.FeatureCollectionPBuffer.Geometry.decode(reader, reader.uint32()),
              );
              break;
            }
            case 6: {
              message.envelope = $root.esriPBuffer.FeatureCollectionPBuffer.Envelope.decode(
                reader,
                reader.uint32(),
              );
              break;
    ...
    FeatureCollectionPBuffer.UniqueIdField = (function () {
      ...
      UniqueIdField.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer.uint32(/* id 2, wireType 0 =*/ 16).bool(message.isSystemMaintained);
        return writer;
      };
      ...
      UniqueIdField.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.esriPBuffer.FeatureCollectionPBuffer.UniqueIdField();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    FeatureCollectionPBuffer.GeometryProperties = (function () {
      ...
      GeometryProperties.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.shapeAreaFieldName);
        if (
          message.shapeLengthFieldName != null &&
          Object.hasOwnProperty.call(message, 'shapeLengthFieldName')
        )
          writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.shapeLengthFieldName);
      ...
      GeometryProperties.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.esriPBuffer.FeatureCollectionPBuffer.GeometryProperties();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      Transform.decode = function decode(reader, length) {
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 2: {
              message.scale = $root.esriPBuffer.FeatureCollectionPBuffer.Scale.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 3: {
              message.translate = $root.esriPBuffer.FeatureCollectionPBuffer.Translate.decode(
                reader,
                reader.uint32(),
              );
              break;
    ...
    FeatureCollectionPBuffer.FeatureResult = (function () {
      ...
      FeatureResult.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.globalIdFieldName);
        if (
          message.geohashFieldName != null &&
          Object.hasOwnProperty.call(message, 'geohashFieldName')
        )
          writer.uint32(/* id 4, wireType 2 =*/ 34).string(message.geohashFieldName);
        if (
        ...
        if (
          ...
          writer.uint32(/* id 9, wireType 0 =*/ 72).bool(message.exceededTransferLimit);
      ...
      FeatureResult.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.esriPBuffer.FeatureCollectionPBuffer.FeatureResult();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 6: {
              message.serverGens = $root.esriPBuffer.FeatureCollectionPBuffer.ServerGens.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 12: {
              message.transform = $root.esriPBuffer.FeatureCollectionPBuffer.Transform.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 13: {
              ...
              message.fields.push(
                $root.esriPBuffer.FeatureCollectionPBuffer.Field.decode(reader, reader.uint32()),
              );
              break;
            }
            case 14: {
            ...
            case 15: {
              ...
              message.features.push(
                $root.esriPBuffer.FeatureCollectionPBuffer.Feature.decode(reader, reader.uint32()),
              );
              break;
            }
            case 16: {
    ...
    FeatureCollectionPBuffer.CountResult = (function () {
      ...
      CountResult.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.esriPBuffer.FeatureCollectionPBuffer.CountResult();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    FeatureCollectionPBuffer.ObjectIdsResult = (function () {
      ...
      ObjectIdsResult.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.esriPBuffer.FeatureCollectionPBuffer.ObjectIdsResult();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 3: {
              if (!(message.objectIds && message.objectIds.length)) message.objectIds = [];
              if ((tag & 7) === 2) {
                var end2 = reader.uint32() + reader.pos;
                while (reader.pos < end2) message.objectIds.push(reader.uint64());
    ...
    FeatureCollectionPBuffer.QueryResult = (function () {
      ...
      QueryResult.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.esriPBuffer.FeatureCollectionPBuffer.QueryResult();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 2: {
              message.countResult = $root.esriPBuffer.FeatureCollectionPBuffer.CountResult.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 3: {
              message.idsResult = $root.esriPBuffer.FeatureCollectionPBuffer.ObjectIdsResult.decode(
                reader,
                reader.uint32(),
              );
              break;
