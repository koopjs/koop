...
const calculateClassBreaks = require('./index.js');
...
test('calculateClassBreaks: normalize by log', (t) => {
  ...
  const result = calculateClassBreaks(features, classification);
  t.deepEquals(result, [
    [0.47712125471966244, 0.7840608393704542],
    [0.7840608393704543, 1.091000424021246],
    [1.091000424021247, 1.3979400086720377],
  ]);
});
...
test('calculateClassBreaks: normalize by percent', (t) => {
  ...
  const result = calculateClassBreaks(features, classification);
  t.deepEquals(result, [
    [4.615384615384616, 15.897435897435901],
    [15.897435897435903, 27.179487179487186],
    [27.179487179487186, 38.46153846153847],
  ]);
});
