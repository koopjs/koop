...
const intersects = require('../../../../lib/filter-and-transform/filters/intersects')
...
test('intersects: LineString outside polygon, false', t => {
  const result = intersects({ type: 'LineString', coordinates: [[17.41, 52.22], [17.42, 52.22]] }, {
    type: 'Polygon',
...
test('intersects: Point inside polygon, Esri Geometry, true', t => {
  const result = intersects({ x: 44, y: -84.5 }, {
    type: 'Polygon',
    coordinates: [[[44, -85], [45, -85], [45, -84], [44, -84], [44, -85]]]
  })
  t.equals(result, true)
