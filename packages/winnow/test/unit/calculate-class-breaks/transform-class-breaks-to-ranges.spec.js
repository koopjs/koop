...
const transformClassBreaksToRanges = require('../../../lib/calculate-class-breaks/transform-class-breaks-to-ranges')
...
test('transformClassBreaksToRanges: stddev', spec => {
  const result = transformClassBreaksToRanges([-3.01, -1.02, 2.01, 6.003, 9.004], { method: 'stddev' })
  spec.deepEquals(result, [
    [-3.01, -1.03],
    [-1.02, 2],
    [2.01, 6.003],
