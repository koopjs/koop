...
test('normalize-query-options, spatial-reference: object with wkt that is Web Mercator string', t => {
  ...
  const SR = normalizeSpatialReference({ wkt })
