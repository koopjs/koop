...
const isTable = require('../../../lib/helpers/is-geojson-table')
...
describe('is-geojson-table', function () {
  ...
  it('GeoJSON collection input with NO geometry should return true', () => {
    const collection = { type: 'FeatureCollection', crs: { type: 'name', properties: { name: 'urn:ogc:def:crs:OGC:1.3:CRS84' } }, features: [{ type: 'Feature', properties: {} }] }
    const result = isTable(collection)
    should(result).be.exactly(true)
  })
