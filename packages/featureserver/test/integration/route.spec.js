...
describe('Routing feature server requests', () => {
  ...
  describe('Layer Info', () => {
    ...
    it('should handle a layer info request of form /FeatureServer/:layerId/info`', (done) => {
      request(app)
  ...
  describe('Query', () => {
    before(function () {
      // This pattern prevents fails from platform-specific logic in farmhash.
      ...
      request(app)
        .get(
          '/FeatureServer/0/query?f=json&' +
            'geometry={"xmin":-15576031.875835987,"ymin":-14167144.570483988,"xmax":15576031.875835987,"ymax":14167144.570483988}&' + // eslint-disable-line
            'geometryType=esriGeometryEnvelope&' +
            'inSR=102100&' +
            'spatialRel=esriSpatialRelIntersects&' +
            'outStatistics=[{"onStatisticField":"OBJECTID","statisticType":"min","outStatisticFieldName":"min_2"},{"onStatisticField":"OBJECTID","statisticType":"max","outStatisticFieldName":"max_2"},{"onStatisticField":"OBJECTID","statisticType":"count","outStatisticFieldName":"count_2"}]&' + // eslint-disable-line
            'where=1=1',
        )
        .expect((res) => {
