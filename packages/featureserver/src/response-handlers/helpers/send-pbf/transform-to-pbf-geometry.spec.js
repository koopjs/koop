...
describe('transformToPbfGeometry', () => {
  ...
  describe('line geometry', () => {
    it('should quantize and format (minimizing required coords) for pbf buffer', () => {
      ...
      result.should.deepEqual({
        lengths: [3],
        coords: [64567221232, -357065421833, 3339584724, 0, 2226389816, 1534703364],
      });
    });
  ...
  describe('polygon geometry', () => {
    it('should quantize and format (minimizing required coords) for pbf buffer', () => {
      ...
      result.should.deepEqual({
        lengths: [5],
        coords: [
          65680416140, -363479548349, 0, 1647807625, -1113194908, 0, 0, -1647807625, 1113194908, 0,
        ],
      });
    });
  });
  ...
  describe('multiline geometry', () => {
    it('should quantize and format for pbf buffer', () => {
      ...
      result.should.deepEqual({
        lengths: [3, 2],
        coords: [
          62340831416, -358626214862, 4452779632, 0, 0, -3205525862, 62340831416, -354020794440,
          4452779632, 0,
        ],
      });
    });
  ...
  describe('multipolygon geometry', () => {
    it('should quantize and format for pbf buffer', () => {
      ...
      result.should.deepEqual({
        lengths: [5, 5],
        coords: [
          87944314299, -346802067873, 0, -1403190256, 2226389816, 0, 0, 1403190256, -2226389816, 0,
          92397093931, -344049811441, 0, -1367402279, 2226389815, 0, 0, 1367402279, -2226389815, 0,
        ],
      });
    });
  });
